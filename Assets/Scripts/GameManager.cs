...
public class GameManager : MonoBehaviour {
  ...
  // To be calledd after a new level scene has been loaded.
  ...
  public void BeginNewRound () {
    ...
    if (_lm.ready) {
      ...
      foreach (GameObject _go in PlayerList) {
        _go.transform.position = _lm.SpawnPoints [i++];
  ...
  // called when a player dies.  When down to the last player, declare them the winner and end the roun.
